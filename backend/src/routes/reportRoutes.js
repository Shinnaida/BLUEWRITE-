...
r.get('/',c.list);r.get('/:id',c.get);r.post('/',c.create);r.put('/:id',c.update);r.patch('/:id/submit',c.submit);r.post('/:id/print',c.print);r.delete('/:id',c.remove);module.exports=r;